document.getElementById('contactForm').addEventListener('submit', function(event) {
    // The browser automatically validates 'required' fields, so if invalid, submission is blocked
    // So if this handler runs, form is valid.

    event.preventDefault(); // Prevents actual form submission

    // Optionally, you can do additional validation here if desired
